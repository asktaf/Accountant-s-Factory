...
<br><br>
        ...
        <div class="row">
            <div class="col-12">
                <h2 id="desktopBannerheading">Ready To Take Your <br/> <u>Finances To The Next Orbit?</u> </h2>
                
                <p>Let's talk! Book your free consultation today</p>
                <a href="contact.php">
                <button class="btn btn-quick">Get In Touch</button>
                </a>
            </div>
        </div>
<br><br>
